                        ...
                        <div class="section-content">
                            <div class="sg-post">
                                <div class="entry-content p-4">
                                    ...
                                    @if(isFileExist(@$page->image, $result = @$page->image->big_image_two))
                                    <div class="entry-header">
                                        <div class="entry-thumbnail" height="100%">
                                            <img class="img-fluid" src="{{safari_check() ? basePath(@$page->image).'/'.$result : static_asset('default-image/default-730x400.png') }} " data-original="{{ basePath(@$page->image) }}/{{ $result }}" alt="{!! $page->title !!}">
                                        </div>
                                    </div>
                                    @endif
