        ...
        <div class="admin-section">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ __('gallery_images') }}</h4>
                    ...
                    <div class="row table-filter-container">
                        <div class="col-12">
                            ...
                            <div class="item-table-filter d-none">
                                <label  class="control-label text-muted">{{ __('language') }}</label>
                            ...
                            <div class="item-table-filter">
                                <label  class="control-label text-muted">{{ __('album') }}</label>
                            ...
                            <div class="item-table-filter">
                                <label  class="control-label text-muted">{{ __('tab') }}</label>
                            ...
                            <div class="item-table-filter">
                                <label  class="control-label text-muted">{{__('search')}}</label>
                            ...
                            <label  class="control-label text-muted">Apply</label>
