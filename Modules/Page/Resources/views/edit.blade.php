                    ...
                    <div class="card-header p-0">
                        ...
                        <div class="card-title">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="post-tab" data-toggle="tab" href="#post-content" role="tab" aria-selected="true">{{ __('edit_page') }}</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input id="page-title" value="{{ $page->title }}" name="title" type="text" class="form-control" required>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="page-slug" class="col-form-label"><b>{{ __('slug') }}</b>
                                                ({{ ('slug_message') }})</label>
                                            <input id="page-slug" value="{{ $page->slug }}" name="slug" type="text" class="form-control">
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="title-meta" class="col-form-label"><b>{{ __('title') }}</b>
                                            ({{ __('meta_tag') }})</label>
                                        <input id="title-meta" name="meta_title" value="{{ $page->meta_title }}" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="page-meta" class="col-form-label"><b>{{ __('description') }}</b>
                                            ({{ __('meta_tag') }})</label>
                                        <input id="page-meta" name="meta_description" value="{{ $page->meta_description }}" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="page-keywords" class="col-form-label"><b>{{ __('keywords') }}</b>
                                            ({{ __('meta_tag') }})</label>
                                        <input id="page-keywords" name="meta_keywords" value="{{ $page->meta_keywords }}" type="text" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-3 p-0">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="page_type" id="page_type" class="form-control">
                                ...
                                <option value="2" {{ $page->page_type==2?"selected":"" }}>{{__('contact_us')}}</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="template" class="col-form-label">{{ __('template') }}</label>
                            <select name="template" id="template" class="form-control">
                                <option value="1" {{ $page->template==1?"selected":"" }}>{{__('without_sidebar')}}</option>
                                <option value="2" {{ $page->template==2?"selected":"" }}>{{__('with_right_sidebar')}}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group d-none">
                            ...
                            <select class="form-control" name="language" id="language">
                                ...
                                <option @if($page->language==$lang->code) Selected
                        ...
                        <div class="form-group ">
                            <button type="submit" class="btn btn-primary float-right"><i class="m-r-10 mdi mdi-content-save-all"></i> {{ __('update_page') }}
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="form-group text-center">
                                ...
                                <img src=" {{basePath($page->image)}}/{{ $result }} " id="image_preview" width="150" class="img-responsive" alt="{!! $page->title !!}">
                                @else
                                <img src="{{static_asset('default-image/default-100x100.png') }} " id="image_preview" width="150"  class="img-responsive" alt="{!! $page->title !!}">
                                @endif
                        ...
                        <div class="form-group text-center">
                            <button type="button" id="btn_image_modal" class="btn btn-primary btn-image-modal" data-id="1" data-toggle="modal" data-target=".image-modal-lg">Add Image
                            </button>
                            <input id="image_id" name="image_id" type="hidden" value="{{$page->image_id}}" class="form-control">
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="visibility" id="visibility_show" value="1" @if ($page->visibility==1)
                                checked
                        ...
                        <div class="col-3">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="visibility" id="visibility_hide" @if ($page->visibility==0)
                                checked
                                @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="show_title" @if ($page->show_title==1)
                                checked
                        ...
                        <div class="col-3">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="show_title" @if ($page->show_title==0)
                                checked
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="show_breadcrumb" @if ($page->show_breadcrumb==1)
                                checked
                        ...
                        <div class="col-3">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="show_breadcrumb" @if ($page->show_breadcrumb==0)
                                checked
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="show_for_register" @if ($page->show_for_register==1)
                                checked
                        ...
                        <div class="col-3">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="show_for_register" @if ($page->show_for_register==0)
                                checked
                    ...
                    <div class="row d-none">
                        ...
                        <div class="col-3">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="show_right_column" @if ($page->show_right_column==1)
                                checked
                        ...
                        <div class="col-3">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="show_right_column" @if ($page->show_right_column==0)
                                checked
                    ...
                    <div class="row d-none">
                        ...
                        <div class="col-3">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="location" @if ($page->location=='top')
                                checked
                        ...
                        <div class="col-3">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="location" @if ($page->location=='mainmenu')
                                checked
                        ...
                        <div class="col-3">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="location" @if ($page->location=='footer')
                                checked
