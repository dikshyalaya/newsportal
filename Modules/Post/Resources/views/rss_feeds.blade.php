                ...
                <div class="card-body">
                    <div class=" all-pages">
                        ...
                        <div class="row table-filter-container">
                            ...
                            <div class="item-table-filter col-8">
                                <input name="search_key" class="form-control" placeholder="{{__('search')}}" type="search" value="">
                            </div>

                            <div class="item-table-filter item-table-style col-4">
                                ...
                                <tbody>
                                    ...
                                    <tr id="row_{{ $feed->id }}">
                                        ...
                                        <td class="justify-content-between">
                                            ...
                                            <a href="{{ route('manually-feeding',['id'=>$feed->id]) }}" title="{{ __('update') }}" class="btn btn-primary btn-sm btn-add-new"><i class="fa fa-refresh"></i>
