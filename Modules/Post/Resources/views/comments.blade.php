    ...
    <div class="container-fluid dashboard-content ">
        ...
        <form action="#" method="post">
            <div class="card admin-section">
                ...
                <div class="card-body navigation-list">
                    <div class="all-pages">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr role="row" id="row_{{ $comment->id }}" class="odd">
                                    ...
                                    @if(Sentinel::getUser()->hasAccess(['comments_delete']))
                                    <td>
                                        <a href="javascript:void(0)" class="btn btn-sm btn-danger active btn-xs" onclick="delete_item('comments','{{ $comment->id }}')"><i class="fa fa-trash"></i></a>
                                    </td>
                                    @endif
                                </tr>
                                @endforeach
