    ...
    <div class="card-body">
        ...
        <div class="row table-filter-container">
            <div class="col-sm-12">
                ...
                <div class="item-table-filte d-none">
        ...
        <!-- Table Filter -->
        <table class="table datatable table-bordered table-hover" role="grid">
            <thead>
                <tr role="row">
                    {{-- <th width="20">
                ...
                <tr id="row_{{ $post->id }}">
                    ...
                    <td>
                        ...
                        <div class="media">
                            ...
                            <img src=" {{basePath($post->image)}}/{{ $result }} " data-src="{{basePath($post->image)}}/{{ $result }}" alt="image" class="mr-3 img-responsive img-thumbnail lazyloaded">

                            @else
                            <img src="{{static_asset('default-image/default-100x100.png') }} " width="200" height="200" alt="image" class="mr-3 img-responsive img-thumbnail">
                            @endif

                            <div class="media-body">
                                <h5 class="mt-0">

                                    <a href="{{ route('article.detail', [$post->slug]) }}">{{ $post->title }} ({{ $post->total_hit }})</a>
                    ...
                    <td>
                        ...
                        <a class="btn btn-sm btn-info" href="{{ route('edit-post',['type'=>$post->post_type,'id'=>$post->id]) }}"><i class="fa fa-edit option-icon"></i>
                        </a>
