                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-12">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            @include('appearance::category_checkbox', ['categories'=>$categories, 'depth'=>0])
                                ...
                                <div class="add-new-page  bg-white col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="">
                                                <a href="javascript:void(0)" onclick="delete_item('menu','{{ $selectedMenus->id }}')" class="text-danger">{{ __('delete_this_menu') }}</a>
                                            </div>
                                            @endif
