...
$php_version_required_max = "7.4.26";
...
<head>
    ...
    <title>News Website Installation</title>
    ...
    <div class="install-box">
        ...
        <div class="panel panel-install">
            <div class="panel-heading text-center">
                <h2>News Website Installation Installation</h2>
            </div>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>@if( OPENSSL_VERSION_NUMBER < 0x009080bf) @php $all_requirement_success=false; @endphp Off @else On @endif </td>
                                            <td>On</td>
                                            <td class="text-center">
                                                @if( OPENSSL_VERSION_NUMBER < 0x009080bf) <i class="status fa fa-times-circle-o"></i>
                                                    @else
                                                    <i class="status fa fa-check-circle-o"></i>
                                                    @endif
                                            </td>
