                        ...
                        <div class="add-new-page  bg-white p-0 m-b-20">
                            ...
                            <nav>
                                <div class="nav m-b-20 setting-tab" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link active" id="setting-url" href="{{ route('settings-url') }}" role="tab">{{ __('url_settings') }}</a>
                                ...
                                <div class="tab-pane fade show active" id="recaptcha_settings" role="tabpanel">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="article_detail_prefix" class="col-form-label">{{ __('article_detail_prefix') }}</label>
                                            <input id="article_detail_prefix" class="form-control" name="article_detail_prefix" value="{{ settingHelper('article_detail_prefix') }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="page_detail_prefix" class="col-form-label">{{ __('page_detail_prefix') }}</label>
                                            <input id="page_detail_prefix" class="form-control" name="page_detail_prefix" data-role="tagsinput" value="{{ settingHelper('page_detail_prefix') }}">
                                        </div>
                                    </div>
