                        ...
                        <div class="add-new-page  bg-white p-20 m-b-20">
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="general_settings" role="tabpanel">
                                    ...
                                    <div class="row">
                                        @if(settingHelper('version') == "" || settingHelper('version') < 142) <div class="col-12 m-t-20 text-center">
                                            <div class="alert alert-danger">
                                ...
                                @if(settingHelper('version') == "" || settingHelper('version') < 142) <div class="row">
                                    <div class="col-12 m-t-20">
                                        <div class="form-group form-float form-group-sm text-right">
                                            <button type="submit" name="status" class="btn btn-primary pull-right"><i class="m-r-10 mdi mdi-content-save-all"></i>{{ __('database_sync') }}
                                            </button>
                                        </div>
                                    </div>
                            </div>
