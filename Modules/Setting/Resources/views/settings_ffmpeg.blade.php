                        ...
                        <div class="add-new-page  bg-white p-0 m-b-20">
                            ...
                            <nav>
                                <div class="nav m-b-20 setting-tab" id="nav-tab" role="tablist">
                                    ...
                                    <!-- <a class="nav-item nav-link active" id="setting-ffmpeg" href="{{ route('settings-ffmpeg') }}" role="tab">{{ __('ffmpeg_settings') }}</a> -->
                                    ...
                                    <div class="row p-l-15">
                                        ...
                                        <div class="col-3 col-md-2">
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="ffmpeg_status" id="visibility_show" value="1" {{ settingHelper('ffmpeg_status') == 1? 'checked':"" }} class="custom-control-input">
                                                <span class="custom-control-label">{{ __('enable') }}</span>
                                            </label>
                                        </div>
                                        <div class="col-3 col-md-2">
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="ffmpeg_status" id="visibility_hide" value="0" class="custom-control-input" {{ settingHelper('ffmpeg_status') == 0? 'checked':"" }}>
                                    ...
                                    <div class="row">
                                        <div class="col-12 m-t-20">
                                            <div class="form-group form-float form-group-sm text-right">
                                                <button type="submit" class="btn btn-primary pull-right"><i class="m-r-10 mdi mdi-content-save-all"></i>{{ __('save_changes') }}
                                                </button>
                                            </div>
                                        </div>
                                    </div>
