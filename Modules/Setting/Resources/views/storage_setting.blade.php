                        ...
                        <div class="add-new-page  bg-white p-0 m-b-20">
                            ...
                            <nav>
                                <div class="nav m-b-20 setting-tab" id="nav-tab" role="tablist">
                                    ...
                                    <!-- <a class="nav-item nav-link active" id="storage-settings" href="{{ route('setting-storage') }}" role="tab">{{ __('storage_settings') }}</a> -->
                                ...
                                <div class="tab-pane fade show active" id="storage_settings" role="tabpanel">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="default_storage" class="col-form-label">{{ __('default_storage') }}</label>
                                            <select name="default_storage" id="default_storage" class="form-control">
                                                <option @if( settingHelper('default_storage')=='local' ) selected @endif value="local">local
                                                </option>
                                                <option @if( settingHelper('default_storage')=='s3' ) selected @endif value="s3">AWS s3
                                                </option>
                                            </select>
                                        </div>
                                    </div>
