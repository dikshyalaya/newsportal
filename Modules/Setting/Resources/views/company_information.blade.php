                        ...
                        <div class="add-new-page  bg-white p-0 m-b-20">
                            ...
                            <nav>
                                <div class="nav m-b-20 setting-tab" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link active" id="contact-settings" href="{{ route('setting-company') }}" role="tab">{{ __('company_informations') }}</a>
                                ...
                                <div class="tab-pane fade show active" id="contact-settings" role="tabpanel">
                                    ...
                                    <div class="col-sm-12 d-none">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="company_language" id="company_language">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="application_name" class="col-form-label">{{ __('application_name') }}</label>
                                            <input id="application_name" name="application_name" value="{{ settingHelper('application_name') }}" type="text" class="form-control" placeholder="Spagreen">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="address" class="col-form-label">{{ __('address') }}</label>
                                            <input id="address" name="address" value="{{ settingHelper('address') }}" type="text" class="form-control" placeholder="Lower Pacific Heights San Francisco">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="email" class="col-form-label">{{ __('email') }}</label>
                                            <input id="email" name="email" type="email" value="{{ settingHelper('email') }}" class="form-control" placeholder="edward_test@domain.com">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="phone" class="col-form-label">{{ __('phone') }}</label>
                                            <input id="phone" name="phone" value="{{ settingHelper('phone') }}" type="text" class="form-control" placeholder="(541) 754-3010">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="zip_code" class="col-form-label">{{ __('zip_code') }}</label>
                                            <input id="zip_code" name="zip_code" value="{{ settingHelper('zip_code') }}" type="text" class="form-control" placeholder="1207">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="country" id="country">
                                                ...
                                                <option @if(settingHelper('country')==$country->name->common) Selected
                                                    @endif
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input id="state" name="state" value="{{ settingHelper('state') }}" type="text" class="form-control" placeholder="State">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input id="city" name="city" value="{{ settingHelper('city') }}" type="text" class="form-control" placeholder="1207">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input id="website" name="website" value="{{ settingHelper('website') }}" type="text" class="form-control" placeholder="Website">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="seo_meta_description" class="col-form-label">{{ __('about_site') }}</label>
                                            <textarea id="about_us_description" class="form-control" name="about_us_description">{{ settingHelper('about_us_description') }}</textarea>
                                        </div>
                                    </div>

                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="copyright_text" class="col-form-label">{{ __('copyright_text') }}</label>
                                            <input id="copyright_text" name="copyright_text" value="{{ settingHelper('copyright_text') }}" type="text" class="form-control" placeholder="{{ __('copyright_text') }}">
                                        </div>
                                    </div>
