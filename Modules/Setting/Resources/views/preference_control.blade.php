                                    ...
                                    <div class="row p-l-15">
                                        ...
                                        <div class="col-3 col-md-2">
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="submit_news_status" id="visibility_show" value="1" {{ settingHelper('submit_news_status') == 1? 'checked':"" }} class="custom-control-input">
                                                <span class="custom-control-label">{{ __('enable') }}</span>
                                            </label>
                                        </div>
                                        <div class="col-3 col-md-2">
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="submit_news_status" id="visibility_hide" value="0" class="custom-control-input" {{ settingHelper('submit_news_status') == 0? 'checked':"" }}>
